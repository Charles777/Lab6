...
public class GamePlay extends GamePlayDomainModel {
	...
	private ArrayList<GameRuleCardsDomainModel> picks;
	private Deck GameDeck = null;
	
	public GamePlay(GameRuleDomainModel rle, ArrayList<GameRuleCardsDomainModel> picks)
	{
	...
	public ArrayList<GameRuleCardsDomainModel> getRulePicks() {
